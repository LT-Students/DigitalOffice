...
namespace LT.DigitalOffice.AuthenticationServiceUnitTests.Token
{
    class JwtValidationTests
    {
        ...
        public void ShouldThrowExceptionWhenTokenIsNotValid()
        {
            ...
            Assert.That(() => jwtValidation.ValidateJwt(userJwt),
                Throws.InstanceOf<Exception>().And
                .Message.EqualTo($"Token failed validation: { expectedExeption}"));
        }
        ...
        public void ShouldThrowExceptionWhenTokeWasWrongFormat()
        {
            ...
            Assert.That(() => jwtValidation.ValidateJwt(userJwt),
                Throws.InstanceOf<Exception>().And
                .Message.EqualTo($"Token was wrong format: { expectedExeption}"));
        }
